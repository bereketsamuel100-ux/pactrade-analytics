  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "hero-gradient text-white hover:scale-105 transition-bounce shadow-button font-semibold",
        success: "success-gradient text-success-foreground hover:scale-105 transition-bounce shadow-button",
        "outline-white": "border-2 border-white text-white bg-transparent hover:bg-white hover:text-primary transition-smooth",
        "ghost-white": "text-white hover:bg-white/10 transition-smooth",
      },
      size: {
